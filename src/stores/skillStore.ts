...
export const SKILL_DEFINITIONS: Record<string, SkillDefinition> = {
  ...
  'wizard-spell-slots-l1': {
    ...
    calculateMax: () => 5,
    refresh: 'Sleep',
    description: 'Level 1 spell slots (5 base, no XP required)',
  },
  'wizard-spell-slots-l2': {
    ...
    calculateMax: () => 4,
    refresh: 'Sleep',
    description: 'Level 2 spell slots (4 base, no XP required)',
  },
  'wizard-spell-slots-l3': {
    ...
    calculateMax: () => 1,
    refresh: 'Sleep',
    description: 'Level 3 spell slots',
  },
  'wizard-spell-slots-l4': {
    ...
    calculateMax: () => 0,
    refresh: 'Sleep',
    description: 'Level 4 spell slots (acquired via XP)',
  },
  'wizard-spell-slots-l5': {
    ...
    calculateMax: () => 0,
    refresh: 'Sleep',
    description: 'Level 5 spell slots (acquired via XP)',
  },
